...
# Having established that, we can proceed to the actual SSL experiments.

# We will mask different percentages of the data and then train 2 models in each scenario. One only using the labeled data, and one leveraging the power of self-training algorithm. We will then analyse how the performance of the two compares across the different scenarios. 
...
# We can notice that on this particular dataset, the self-training algorithm doesn't seem to be very helpful. 
